...
/** getPictureById GET /api/picture/get/${param0} */
export async function getPictureByIdUsingGet(
  ...
  return request<API.BaseResponsePicture_>(`/api/picture/get/${param0}`, {
    method: 'GET',
    params: {
      ...queryParams,
    },
...
/** getPictureVOById GET /api/picture/get/vo/${param0} */
export async function getPictureVoByIdUsingGet(
  ...
  const { id: param0, ...queryParams } = params
  return request<API.BaseResponsePictureVO_>(`/api/picture/get/vo/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
